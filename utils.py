...
def vec_neg_uniform_sample(train_df, neg_adj_list):
    ...
    # Sample negative items in a vectorized manner
    neg_items = [np.random.choice(neg_adj_list[user]['neg_items']) for user in users]

    # Stack users, pos_items, and neg_items into a final array
